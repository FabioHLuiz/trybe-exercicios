...
//  Crie uma função que retorne uma saudação matinal.
...
//  Crie uma função que receba dois numeros (parâmentros) e retorne a soma entre else.
...
// Crie uma função que receba dois numeros inteiros e retorne o menor valor entre eles.
