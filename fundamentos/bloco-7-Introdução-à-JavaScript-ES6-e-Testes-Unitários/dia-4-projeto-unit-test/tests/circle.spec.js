...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Testando undefined caso o retorno passado não seja um numero', () => {
    expect(circle('oi')).toBeUndefined(undefined);
  });
  // Teste se circle retorna um objeto.
  it('Testando se a função circle retorna um objeto', () => {
    expect(typeof circle(7)).toBe('object');
  });
  // Teste se o objeto retornado possui 3 propriedades.
  it('Testando se possui 3 propriedasdes', () => {
    expect(circle(3)).toHaveProperty('area', 'circumference', 'radius')
  });
  // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
  it('Testando undefined para parametros vazios', () => {
