...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('Teste para saber se a função recebendo numeros retorna true', () => {
    expect(numbers([1, 2, 3, 4, 5])).toBe(true)
  });

  // Escreva um teste em que a função recebe [1, 2, '3', 4, 5] e retorna false
  it('Teste para saber se a função recebendo numeros retorna false', () => {
    expect(numbers([1, 2, '3', 4, 5])).toBe(false)
  });

  // Escreva um teste em que a função recebe [1, 'a', 3] e retorna false
  it('Teste para saber se a função recebendo numeros e uma str retorna false', () => {
    expect(numbers([1, 'a', 3])).toBe(false)
  });

  // Escreva um teste em que a função recebe [' '] e retorna false
  it('Teste para saber se a função recebendo parametro vazio retorna false', () => {
