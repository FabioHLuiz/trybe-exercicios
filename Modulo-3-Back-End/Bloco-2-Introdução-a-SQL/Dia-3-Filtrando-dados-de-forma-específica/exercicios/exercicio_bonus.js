...
INSERT INTO Scientists(SSN, Name)
 ...
 INSERT INTO AssignedTo (Scientist, Project)
  VALUES (123234877, 'AeH1'),
    ...
    // 8-Escreva uma query para exibir o nome e o código de todos os projetos cujo nome NÃO inicie com a letre A .
    USE Scientists;
    SELECT Code, Name FROM Projects
    WHERE Name NOT LIKE 'A%';
    
    // 9-Escreva uma query para exibir o nome de todos os projetos cujo código contenha a letra H.
    USE Scientists;
    SELECT Name FROM Projects
    WHERE Code LIKE '%H%';